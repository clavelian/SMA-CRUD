        ...
        <header>
            <div id="fixed" className="inner">
                        ...
                        <svg viewBox="0 0 202.15 184.39">
                            <defs>
                                <radialGradient id="radial-gradient" cx="95.77" cy="97.77" fx="76.36006384576115" r="90.67" gradientUnits="userSpaceOnUse">
                                    ...
                                    <stop offset="0.16" stopColor="#fbc09a"></stop>
                                    <stop offset="0.41" stopColor="#f8aa9b"></stop>
                                    <stop offset="0.71" stopColor="#f4879c"></stop>
                                    <stop offset="1" stopColor="#ef5f9e"></stop>
                                </radialGradient>
                            </defs>
                ...
                <nav className="navigation">
                    ...
                    <ul className="right">
                        <li><a href="#">Twice Official Website</a></li>
